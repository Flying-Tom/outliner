...
import 'package:pdf_toc/ui/home_page.dart';
import 'package:pdf_toc/utils/font_manager.dart';
import 'package:shared_preferences/shared_preferences.dart';

class PdfTOCApp extends StatefulWidget {
  const PdfTOCApp({super.key});

  @override
  State<PdfTOCApp> createState() => _PdfTOCAppState();
}

class _PdfTOCAppState extends State<PdfTOCApp> {
